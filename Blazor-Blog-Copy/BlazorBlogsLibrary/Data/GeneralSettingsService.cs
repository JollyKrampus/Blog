...
namespace BlazorBlogsLibrary.Data
{
    public class GeneralSettingsService
    {
        ...
        {
            var objGeneralSettings = new GeneralSettings();

            var resuts = await _context.Settings.AsNoTracking().ToListAsync();

            objGeneralSettings.SMTPServer =
                Convert.ToString(resuts.FirstOrDefault(x => x.SettingName == "SMTPServer").SettingValue);
            objGeneralSettings.SMTPAuthendication =
                Convert.ToString(resuts.FirstOrDefault(x => x.SettingName == "SMTPAuthendication").SettingValue);
            objGeneralSettings.SMTPSecure =
                Convert.ToBoolean(resuts.FirstOrDefault(x => x.SettingName == "SMTPSecure").SettingValue);
            objGeneralSettings.SMTPUserName =
                Convert.ToString(resuts.FirstOrDefault(x => x.SettingName == "SMTPUserName").SettingValue);
            objGeneralSettings.SMTPPassword =
                Convert.ToString(resuts.FirstOrDefault(x => x.SettingName == "SMTPPassword").SettingValue);
            objGeneralSettings.SMTPFromEmail =
                Convert.ToString(resuts.FirstOrDefault(x => x.SettingName == "SMTPFromEmail").SettingValue);

            objGeneralSettings.AllowRegistration =
                Convert.ToBoolean(resuts.FirstOrDefault(x => x.SettingName == "AllowRegistration").SettingValue);
            objGeneralSettings.VerifiedRegistration =
                Convert.ToBoolean(resuts.FirstOrDefault(x => x.SettingName == "VerifiedRegistration").SettingValue);

            objGeneralSettings.ApplicationName =
                Convert.ToString(resuts.FirstOrDefault(x => x.SettingName == "ApplicationName").SettingValue);
            objGeneralSettings.ApplicationLogo =
                Convert.ToString(resuts.FirstOrDefault(x => x.SettingName == "ApplicationLogo").SettingValue);
            objGeneralSettings.ApplicationHeader =
                Convert.ToString(resuts.FirstOrDefault(x => x.SettingName == "ApplicationHeader").SettingValue);

            objGeneralSettings.DisqusEnabled =
                Convert.ToString(resuts.FirstOrDefault(x => x.SettingName == "DisqusEnabled").SettingValue);
            objGeneralSettings.DisqusShortName =
                Convert.ToString(resuts.FirstOrDefault(x => x.SettingName == "DisqusShortName").SettingValue);

            if (resuts.FirstOrDefault(x => x.SettingName == "GoogleTrackingID") != null)
                objGeneralSettings.GoogleTrackingID =
                    Convert.ToString(resuts.FirstOrDefault(x => x.SettingName == "GoogleTrackingID").SettingValue);
            else
                objGeneralSettings.GoogleTrackingID = "";

            objGeneralSettings.VersionNumber =
                Convert.ToString(resuts.FirstOrDefault(x => x.SettingName == "VersionNumber").SettingValue);
