...
namespace BlazorBlogsLibrary.Controllers
{
    ...
    public class RestartAppController : Controller
    {
        ...
        {
            var WebConfigOrginalFileNameAndPath = _hostEnvironment.ContentRootPath + @"\Web.config";
            var WebConfigTempFileNameAndPath = _hostEnvironment.ContentRootPath + @"\Web.config.txt";
